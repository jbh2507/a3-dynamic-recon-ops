...
{
	diag_log format ["Delete button %3 - X: %1, Y: %2", _ctrlX, _ctrlY, _x];
...
_ctrlY = _startY;
{
	diag_log format ["Unit title %3 - X: %1, Y: %2", _ctrlX, _ctrlY, _x];
	((findDisplay 626262) displayCtrl _x) ctrlSetPosition [(_ctrlX * safezoneW + safezoneX), (_ctrlY * safezoneH + safezoneY)];
	((findDisplay 626262) displayCtrl _x) ctrlCommit 0;
	_ctrlX = _ctrlX;
	_ctrlY = _ctrlY + _spacer;
...
{
	diag_log format ["Loadout combobox %3 - X: %1, Y: %2", _ctrlX, _ctrlY, _x];
	((findDisplay 626262) displayCtrl _x) ctrlSetPosition [(_ctrlX * safezoneW + safezoneX), (_ctrlY * safezoneH + safezoneY)];
	((findDisplay 626262) displayCtrl _x) ctrlCommit 0;
	_ctrlX = _ctrlX;
	_ctrlY = _ctrlY + _spacer;
...
_ctrlY = (_startY + 0.01);
{
	diag_log format ["VA button %3 - X: %1, Y: %2", _ctrlX, _ctrlY, _x];
	((findDisplay 626262) displayCtrl _x) ctrlSetPosition [(_ctrlX * safezoneW + safezoneX), (_ctrlY * safezoneH + safezoneY)];
	((findDisplay 626262) displayCtrl _x) ctrlCommit 0;
	_ctrlX = _ctrlX;
	_ctrlY = _ctrlY + _spacer;
